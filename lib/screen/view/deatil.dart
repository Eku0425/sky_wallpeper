        ...
        children: [
            ...
            child: GestureDetector(
              ...
              child: ImageFiltered(
                imageFilter: ImageFilter.compose(
                    inner: ImageFilter.blur(sigmaX: 0),
                    outer: ImageFilter.blur(sigmaY: 0)),
                child: Container(
                  width: screenWidth,
                  height: screenHeight,
                  ...
                  child: FadeInImage(
                    ...
                    placeholder: AssetImage(
                        'assets/img/b6e0b072897469.5bf6e79950d23 (1).gif'),
          ...
          Container(
            margin: EdgeInsets.only(
                left: 20, right: 20, top: screenHeight / 1.2, bottom: 10),
            width: screenWidth / 1,
