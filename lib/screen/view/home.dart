...
import 'package:sky_wallpeper/screen/view/search.dart';

import '../provider/wallpepar_provider.dart';
import 'deatil.dart';
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                      onTap: () async {
                        selectWall = index;
                        name =
                            wallpaperProvider.wallpaperModel.hits![index].user;
                        user = wallpaperProvider
                            .wallpaperModel.hits![index].userImageUrl;
                        views = wallpaperProvider
                            .wallpaperModel.hits![index].views
                            .toString();
                        wallpaper = wallpaperProvider
                            .wallpaperModel.hits![index].largeImageUrl;
                        Navigator.of(context).push(MaterialPageRoute(
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: FadeInImage(
                            ...
                            placeholder: AssetImage('assets/img/gif1.gif'),
                            image: NetworkImage(
                              wallpaperProvider
                                  .wallpaperModel.hits![index].webformatUrl,
                            ),
                          ),
                        ),
                      ),
