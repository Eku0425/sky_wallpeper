                    ...
                    itemBuilder: (context, index) => GestureDetector(
                      onTap: () async {
                        name = wallpaperProvider
                            .wallpaperModelSerach.hits![index].user;
                        user = wallpaperProvider
                            .wallpaperModelSerach.hits![index].userImageUrl;
                        views = wallpaperProvider
                            .wallpaperModelSerach.hits![index].views
                            .toString();
                        wallpaper = wallpaperProvider
                            .wallpaperModelSerach.hits![index].largeImageUrl;
                        ...
                        child: ClipRRect(
                          ...
                          child: FadeInImage(
                            ...
                            placeholder: AssetImage(
                                'assets/img/8d89ca607c0ff0f87bd5ed16a6f82ff5.gif'),
                            image: NetworkImage(
                              provider.wallpaperModelSerach.hits![index]
                                  .webformatUrl,
                            ),
                          ),
                        ),
